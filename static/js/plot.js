...
function rebuildPlots(data,sampleIndex) {
     {
        var samples = data.samples;
        var barSample = samples[sampleIndex];
        console.log(barSample);
        ...
        Plotly.restyle('bubble', bubData, bubLayout);
    };
